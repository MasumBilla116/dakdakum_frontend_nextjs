...
export default function Related(){
	return(<>
		<div className="ml-2 mr-2 mx-auto mb-8">
		    <div className="grid grid-flow-rows lg:grid-cols-8 md:grid-cols-8 sm:grid-cols-8 xs:grid-cols-8">
		        <div className="lg:col-span-2 md:col-span-3 sm:col-span-3 xs:col-span-6">
		            <h1 className="text-3xl text-orange-red font-bold mt-4">
		                Related product
		            </h1>
		        </div>
		        <div className="lg:col-span-6 md:col-span-5 sm:col-span-5 xs:col-span-2 mt-4 flex flex-wrap items-center justify-cente">
